                ...
                <div class="">
                  <?php
                   ...
                   <div class="w3-accordion w3-light-blue">
                      <div onclick="myFunction('<?php echo $y; ?>')" id="pr_<?php echo $y; ?>" class=" w3-left-align w3-light-green heaederp-edit" style="padding-left:20px;
                                                                                                                                padding-top:20px;
                      ...
                      <div class="row  w3-hide-large w3-hide-medium">  <!-- small Navs -->
                       ...
                       <div id="prr_<?php echo $y; ?>" class="w3-accordion-content w3-container">
                         <?php#  include 'update_student.php';
                          ...
                          <div class="well4student-details list">
                            <span class="span1">Name</span>
                               <span id="alter1">
                                  ...
                                  <span class="fa fa-edit edit " onclick="editthisRow('<?php echo  ?>')" id="<?php echo $a['fname']?>" title="edit"></span>
                               </span>
                              <span> <?php $a['enrollDate']  ?> </span>
                             <div id="editing1" class="rowl">
                               <div class="col-s">
                                 <form id="form-submit" method="post">
                                  ...
                                  <button type="button" class="exitEdit1">&times;</button>
                                </form>
                              </div>
                            </div>
                          ...
                          <div class="well4student-details list">
                            ...
                            <span id="alter2">
                             ...
                             <span class="fa fa-edit edit changingedit2" title="edit"></span>
                           </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing2" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit2">&times;</button>
                               </form>
                             </div>
                           </div>
                           </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter3">
                               ...
                               <span class="fa fa-edit edit changingedit3" title="edit"></span>
                           </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing3" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                  ...
                                  <input type="hidden" name="reg" value="<?php echo $a['regNumber']  ?>">
                                 <input type="submit" name="send2" value="update" onclick="document.getElementById('dbres').style.display='block'">
                                 <button type="button" class="exitEdit3">&times;</button>
                               </form>
                             </div>
                           </div>
                           </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter4">
                             ...
                             <span class="fa fa-edit edit changingedit4" title="edit"></span>
                           </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing4" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit4">&times;</button>
                               </form>
                             </div>
                           </div>
                           </div>
                           ...
                           <div id="editing5" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit5">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter6">
                             ...
                             <span class="fa fa-edit edit changingedit6" title="edit"></span>
                           </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing6" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit6">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter7">
                               ...
                               <span class="fa fa-edit edit changingedit7" title="edit">
                             </span>
                               <span> <?php $a['enrollDate']  ?> </span>
                              <div id="editing7" class="rowl">
                                <div class="col-s">
                                  <form id="form-submit" method="post">
                                   ...
                                   <button type="button" class="exitEdit7">&times;</button>
                                 </form>
                               </div>
                             </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter8">
                               ...
                               <span class="fa fa-edit edit changingedit8" title="edit"></span>
                             </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing8" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit8">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter9">
                              ...
                              <span class="fa fa-edit edit changingedit9" title="edit"></span>
                            </span>
                            <span> <?php $a['enrollDate']  ?> </span>
                           <div id="editing9" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit9">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter10">
                              ...
                              <span class="fa fa-edit edit changingedit10" title="edit"></span>
                           </span>
                            <span> <?php $a['enrollDate']  ?> </span>
                           <div id="editing10" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit10">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter11">
                               ...
                               <span class="fa fa-edit edit changingedit11" title="edit"></span>
                             </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing11" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit11">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter12">
                               <span class="span2"><?php echo $a['bornday'].'<br>'; ?></span>
                                <span class="fa fa-edit edit changingedit12" title="edit">
                              </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing12" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit12">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter13">
                               ...
                               <span class="fa fa-edit edit changingedit13" title="edit"></span>
                            </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing13" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit13">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter14">
                              <span class="span2"><?php echo $a['mstatus'].'<br>'; ?></span>
                               <span class="fa fa-edit edit changingedit14" title="edit"></span>
                             </span>
                            <span> <?php $a['enrollDate']  ?> </span>
                           <div id="editing14" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit14">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter15">
                              ...
                              <span class="fa fa-edit edit changingedit15" title="edit"></span>
                            </span>
                            <span> <?php $a['enrollDate']  ?> </span>
                           <div id="editing15" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit15">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter16">
                              ...
                              <span class="fa fa-edit edit changingedit16" title="edit"></span>
                            </span>
                            <span> <?php $a['enrollDate']  ?> </span>
                           <div id="editing16" class="rowl">
                             <div class="col-s">
                               <form id="form-submit" method="post">
                                ...
                                <button type="button" class="exitEdit16">&times;</button>
                              </form>
                            </div>
                          </div>
                          </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter17">
                              ...
                              <span class="fa fa-edit edit changingedit17" title="edit"></span>
                            </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing17" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit17">&times;</button>
                               </form>
                             </div>
                           </div>
                           </div>
                          <div class="well4student-details list">
                            ...
                            <span id="alter18">
                               ...
                               <span class="fa fa-edit edit changingedit18" title="edit"></span>
                             </span>
                             <span> <?php $a['enrollDate']  ?> </span>
                            <div id="editing18" class="rowl">
                              <div class="col-s">
                                <form id="form-submit" method="post">
                                 ...
                                 <button type="button" class="exitEdit18">&times;</button>
                               </form>
                             </div>
                           </div>
                          </div>
